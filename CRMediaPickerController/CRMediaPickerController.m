...
- (void)saveEditedImage:(UIImage *)image failureblock:(void (^)(NSError *))failureblock successblock:(void (^)(ALAsset *))successblock {
    ALAssetsLibrary *assetsLibrary = [[self class] defaultAssetsLibrary];
    [assetsLibrary writeImageToSavedPhotosAlbum:image.CGImage orientation:(ALAssetOrientation) image.imageOrientation completionBlock:^(NSURL *assetURL, NSError *error) {

        if (!error) {

            [assetsLibrary assetForURL:assetURL resultBlock:successblock failureBlock:failureblock];
